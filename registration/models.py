...
class Event(models.Model):
    business_id = models.PositiveIntegerField(_("Business ID"), default=1)
    name = models.CharField(_("Event Name"), max_length=400, blank=True, null=True)
    scheduled_time = models.DateTimeField(verbose_name=_('Scheduled Date and Start Time'))

...
urlpatterns = [
    ...
    path('schedule/events/', views.ScheduleEvents.as_view(), name='schedule_events'),
    path('schedule/google/oauth/start/', views.GoogleOAuthStart.as_view(), name='google_oauth_start'),
    path('schedule/google/oauth/callback/', views.GoogleOAuthCallback.as_view(), name='google_oauth_callback'),
    path('schedule/google/publish/', views.PublishEventsToGoogleCalendar.as_view(), name='publish_google_calendar'),
